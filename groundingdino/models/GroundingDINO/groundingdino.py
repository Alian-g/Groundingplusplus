...
class GroundingDINO(nn.Module):
    ...
    def forward(self, samples: NestedTensor, targets: List = None, **kw):
        ...
        hs, reference, hs_enc, ref_enc, init_box_proposal, enc_pack = self.transformer(
        ...
        out = {
            ...
            "pred_boxes": outputs_coord_list[-1],  # bs, num_queries, 4, normalized cxcywh
            "enc_pack": enc_pack,
        }

        # optional: intermediate decoder outputs for auxiliary loss/debug
        if self.aux_loss:
            out["aux_outputs"] = self._set_aux_loss(outputs_class, outputs_coord_list)

        # optional: two-stage encoder outputs
